...
// used to generate this class and read the Tree.
	if (tree == 0) {
		TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/opt/sbg/cms/ui2_data1/rhaeberl/CMSSW_10_6_27/src/stage/ntuple/test/prod/nt_mc_aod_gluino2000_2.root"); //opt/sbg/cms/ui3_data1/dapparu/HSCP/Production/prodMarch2021_CMSSW_10_6_2/HSCPgluino_M-1600_TuneCP5_13TeV-pythia8/MC17_Gluino1600_runv3/210324_135858/0000

		if (!f || !f->IsOpen()) {
			f = new TFile("/opt/sbg/cms/ui2_data1/rhaeberl/CMSSW_10_6_27/src/stage/ntuple/test/prod/nt_mc_aod_gluino2000_2.root");
		}
		
	
		TDirectory * dir = (TDirectory*)f->Get("/opt/sbg/cms/ui2_data1/rhaeberl/CMSSW_10_6_27/src/stage/ntuple/test/prod/nt_mc_aod_gluino2000_2.root:/stage"); 
